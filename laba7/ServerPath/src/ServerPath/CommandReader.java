        ...
        try {
            ...
            switch (com.getName()) {
                case "add":
                    ...
                    resWriter.writeResponse(new CommandResponse(message, 1), address);
                ...
                case "remove_by_id":
                    ...
                    resWriter.writeResponse(new CommandResponse(message, ((ComRemoveById) commandsList.get(9)).getExecuteStatus()), address);
                    ((ComHistory) commandsList.get(7)).addToHistory(com.getName());
                    break;
                ...
                case "remove_head":
                    ...
                    resWriter.writeResponse(new CommandResponse(message, ((ComRemoveHead) commandsList.get(10)).getExecuteStatus()), address);
                    ((ComHistory) commandsList.get(7)).addToHistory(com.getName());
                    break;
                ...
                case "update_by_id":
                    if (args instanceof String) {
                        ...
                        resWriter.writeResponse(new CommandResponse(message, ((ComUpdateById) commandsList.get(14)).getExecuteStatus()), address);
                        ((ComHistory) commandsList.get(7)).addToHistory(com.getName());
